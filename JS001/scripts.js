...
const user = { email: 'matheus@teste.com', password: 'teste123', age: 30 } // object lit console.log(user)
...
const list = ['a', 'b', 'c', 'd', 'e'] // comecam a contar de
...
const bigNumbers = [1, 2, 3, 4, 5, 10, 100].filter(function (number) { return number >= 5
})
...
// Funções
function minhaFuncao() { console.log('Olá função!')
}
minhaFuncao()
